      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h1 class="mb-0 fs-3">Alunos & Responsáveis</h1>
              </div>
              <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Alunos & Responsáveis</li>
                  </ol>
                </nav>
              </div>
            </div>
                      ...
                      <div class="col-12 col-md-8">
                        <div class="d-flex flex-wrap justify-content-md-end gap-2">
                          ...
                          <button
                            ...
                            data-bs-target="#modal-add-alunos"
                          >
                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          @forelse ($listaAlunos as $aluno)

                          @php

                           $turma = $aluno->alunoTurma;

                           $responsavel = $aluno->alunoResponsavel;
                          ...
                          @endphp
                            <tr>
                              ...
                              <td>
                                @if ($aluno->foto_aluno)
                                    <img 
                                    src="{{ asset('atlas/upload/' . $aluno->foto_aluno) }}" 
                                ...
                                <!-- Turma  -->
                              <td>{{ $turma ? $turma->nome_turma : 'Nenhuma turma atribuída'}}</td>
                              <td>
                                {{-- Nome --}}
                                <div class="d-flex align-items-center">
                                  <span class="fw-medium">{{ $aluno->nome_aluno }}</span>
                                </div>
                              </td>
                              <!-- Responsável -->
                              <td>{{ $responsavel->nome_responsavel}}</td>
                              <!-- Data de Nascimento -->
                              <td>{{ $aluno->data_nascimento_aluno ? $aluno->data_nascimento_aluno->format('d/m/Y') : 'Data não encontrada'}}</td>
                              <!-- Sexo -->
                              ...
                              <td class="text-end">
                                <div class="btn-group btn-group-sm">
                                  <button
                                    ...
                                    aria-label="Editar {{ $aluno->nome_aluno }}"
                                  >
                                  ...
                                  <button
                                    ...
                                    data-bs-toggle="modal"
                                    data-bs-target="#modal-delete-aluno"
                                    aria-label="Deletar {{ $aluno->nome_aluno }}"
                                  >
              ...
              <div class="col-12">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-header">
                    <div class="row g-2 align-items-center">
                      <div class="col-12 col-md-4">
                        <h3 class="card-title">Responsáveis cadastrados</h3>
                      </div>
                      <div class="col-12 col-md-8">
                        <div class="d-flex flex-wrap justify-content-md-end gap-2">
                          <div class="input-group input-group-sm w-auto">
                            ...
                            <input
                              ...
                              id="user-search"
                              class="form-control"
                              placeholder="Buscar responsaveis"
                              aria-label="Buscar responsaveis"
                              style="width: 180px"
                            />
                          </div>
                          <select
                          ...
                          <button
                            ...
                            class="btn btn-sm btn-primary"
                            data-bs-toggle="modal"
                            data-bs-target="#modal-add-responsaveis"
                          >
                            <i class="bi bi-person-plus-fill me-1" aria-hidden="true"> </i>
                            Novo responsável
                          </button>
                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          @forelse ($listaResponsaveis as $responsavel)
                            <tr>
                              <td>{{ $responsavel->id_responsavel }}</td>
                                {{-- Foto  --}}
                              <td>
                                @if ($responsavel->foto_responsavel)
                                    <img 
                                    src="{{ asset('atlas/upload/' . $responsavel->foto_responsavel) }}" 
                                    alt="{{ $responsavel->nome_responsavel }}"
                                    class="rounded"
                                    style="
                                      width: 100px;
                                      height: 60px;
                              ...
                              <td>
                                {{-- Nome --}}
                                <div class="d-flex align-items-center">
                                  <span class="fw-medium">{{ $responsavel->nome_responsavel }}</span>
                                </div>
                              </td>
                              <!-- CPF -->
                              ...
                              {{-- Status --}}
                              <td>
                                @if ($responsavel->status_responsavel === 'ATIVO')
                                  <span class="badge text-bg-success">Ativo</span>
                                @else
                                  <span class="badge text-bg-warning">Inativo</span>
                                @endif
                              ...
                              <td class="text-end">
                                <div class="btn-group btn-group-sm">
                                  <button
                                    type="button"
                                    class="btn btn-outline-secondary"
                                    aria-label="Editar {{ $responsavel->nome_responsavel }}"
                                  >
                                    <i class="bi bi-pencil" aria-hidden="true"> </i>
                                  </button>
                                  <button
                                    ...
                                    class="btn btn-outline-danger"
                                    data-bs-toggle="modal"
                                    data-bs-target="#modal-delete-responsavel"
                                    aria-label="Deletar {{ $responsavel->nome_responsavel }}"
                                  >
                                    <i class="bi bi-trash" aria-hidden="true"> </i>
                                  </button>
                                </div>

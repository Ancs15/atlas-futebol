...
Route::get('/admin/turmas', [TurmaController::class, 'index'])->name('admin.turma.index');
Route::get('/admin/logos', [LogoController::class, 'index'])->name('admin.logo.index');
Route::get('/admin/depoimentos', [DepoController::class, 'index'])->name('admin.depoimentos.index');